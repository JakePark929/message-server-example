...
public class ChannelEntity extends BaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        final ChannelEntity that = (ChannelEntity) o;
    ...
    public String toString() {
        return "ChannelEntity{channelId=%d, title='%s', channelInviteCode='%s', headCount=%d}".formatted(channelId, title, channelInviteCode, headCount);
    }
}
