...
public class UserConnectionId implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        final UserConnectionId that = (UserConnectionId) o;
    ...
    public String toString() {
        return MessageFormat.format("UserConnectionId'{'partnerAUserId={0}, partnerBUserId={1}'}'", partnerAUserId, partnerBUserId);
    }
}
