...
public class CacheService {
    ...
    public List<String> get(Collection<String> keys) {
        try {
            ...
            log.error("Redis mget failed. keys: {}, cause: {}", keys, e.getMessage());
        }
    ...
    public boolean delete(String key) {
        try {
            ...
            log.error("Redis delete failed. key: {}, cause: {}", key, e.getMessage());
        }
    ...
    public boolean expire(String key, Long ttlSeconds) {
        try {
            ...
            log.error("Redis expire failed. key: {}, cause: {}", key, e.getMessage());
        }
        return false;
    }
}
