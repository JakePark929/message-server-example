...
import com.jake.messagesystem.db.RoutingDataSource;
...
public class DataSourceConfig {
    ...
    @Bean
    public DataSourceInitializer sourceMessage1Initializer(DataSource sourceMessage1DataSource) {
        return dataSourceinitializer(sourceMessage1DataSource, new ChannelId(1L));
    }

    @Bean
    public DataSourceInitializer sourceMessage2Initializer(DataSource sourceMessage2DataSource) {
    ...
    private DataSourceInitializer dataSourceinitializer(DataSource dataSource, ChannelId channelId) {
        ...
        if (channelId == null) {
            populator.addScript(new ClassPathResource("message-system.sql"));
        } else {
