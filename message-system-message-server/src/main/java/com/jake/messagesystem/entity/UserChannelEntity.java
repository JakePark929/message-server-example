...
public class UserChannelEntity extends BaseEntity{
    ...
    public boolean equals(Object o) {
        ...
        final UserChannelEntity that = (UserChannelEntity) o;
    ...
    public String toString() {
        return "UserChannelEntity{userId=%d, channelId=%d, lastReadMsgSeq=%d}".formatted(userId, channelId, lastReadMsgSeq);
    }
}
